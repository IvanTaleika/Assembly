...
.data
    ...
    snakeCell equ 070Fh ;White shuriken
    point equ 0504h ;Purple rhomb 
    nextLvlPoint equ 0404h ;Red rhomb
        
    nTwo db 02h
       
    welcomText db "Welcom to the game Snake!",0Dh,0Ah,"Control:",0Dh,0Ah,'$'
    controlText db 18h,", ",19h,", -> , <- - move snake",0Dh,0Ah,"Backspace - restart",0Dh,0Ah,"Esc - exit",0Dh,0Ah,'$' 
